...
@section('page')
    ...
    <form class="employee-card card-inner" method="POST" action="" enctype="multipart/form-data">
      ...
      <div class="employee-grid">
        <div class="perant-input employee-avatar-field">
          ...
          <label class="avatar-upload" for="photo" data-no-active>
            ...
            <span class="avatar-preview">
              <img id="photoPreview" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=800&q=80" loading="lazy" alt="Profile Preview" style="display:block;">
        ...
        <div class="perant-input">
          ...
          <input type="text" id="name" name="name" placeholder="Enter employee name" value="Kareem Abogabal">
        </div>
        <div class="perant-input">
          <label for="job" data-no-active>Job Title</label>
          <input type="text" id="job" name="job" placeholder="Enter job title" value="software engineer">
        </div>
        <div class="perant-input">
          <label for="job-role" data-no-active>Job role</label>
          <input type="text" id="job-role" name="job-role" placeholder="Job role" value="admin">
        </div>
        <div class="perant-input">
          <label for="phone" data-no-active>Phone Number</label>
          <input type="tel" id="phone" name="phone" placeholder="+20 100 000 0000" value="01092320210">
        </div>
        <div class="perant-input">
          <label for="email" data-no-active>Email</label>
          <input type="email" id="email" name="email" placeholder="employee@gmail.com" value="kareemabogabal41@gmail.com">
        </div>
        <div class="perant-input">
          <label for="email-company" data-no-active>Email company</label>
          <input type="email" id="email-company" name="email-company" placeholder="employee@company.com" value="kareem41@gmail.com">
        </div>
        <div class="perant-input">
        ...
        <div class="perant-input">
          <label for="ip_address" data-no-active>IP Address</label>
          <input type="text" id="ip_address" name="ip_address" placeholder="192.168.1.10">
        </div>
        <div class="perant-input full-row">
          <label for="salary" data-no-active>Salary</label>
          <input type="text" id="salary" name="salary" placeholder="Enter salary" disabled>
        </div>
  ...
  <script src="{{ asset('js/company/programmers/settings.js') }}"></script>
@endsection