...
<body>
    <style>
        ...
        *::selection {
        ...
        body {
            ...
            background:
                radial-gradient(circle at top, rgba(76, 99, 188, 0.20), transparent 38%),
                radial-gradient(circle at bottom, rgba(9, 16, 54, 0.65), transparent 45%),
                #020018;
            color: #f4f7ff;
            overflow: hidden;
            cursor: none;
        ...
        .boy-badge {
            ...
            top: 85px;
            left: 65px;
            filter: drop-shadow(3px 2px 0px #0f1730);
        }
        ...
        .boy-face {
            ...
            top: 130px;
            left: 135px;
            filter: drop-shadow(0px 2px 0px #0f1730);
        }
        ...
        .keyboard {
            ...
            position: absolute;
            border-radius: 5px;
            border-bottom: 3px solid #050813;
            z-index: 6;
        }
        ...
        .server-disc {
            ...
            right: 5px;
            border-radius: 3px;
            border-bottom: 2px solid #050813;
        ...
        .error-btn {
            ...
            letter-spacing: 0.2px;
            color: #020018;
            background: linear-gradient(135deg, #ffd84d, #8ef0ff);
        ...
        <div class="boy">
            ...
            <div class="boy-head">
                ...
                <svg height="100" width="100" class="tear">
                    <path d="m 20 0 q 0 5 5 15 q 8 14 -5 15 q -13 -1 -5 -15 q 3 -6 5 -15 z " stroke="#bad9ff"
                        stroke-width="2" fill="#bad9ff" />
                </svg>
                <div class="boy-eyes">
    ...
    <div class="error-content">
        ...
        <p>We are currently receiving too many requests. Please wait a moment and try again.</p>
        <a class="error-btn" href="/">Try Again</a>
    </div>
